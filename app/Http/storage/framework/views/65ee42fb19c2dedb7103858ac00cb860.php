    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid px-5 d-flex justify-content-between align-items-center">
            <a class="navbar-brand" href="<?php echo e(route('landing')); ?>">
                <img src="<?php echo e(asset('assets/img/icons/logo.svg')); ?>" alt="Logo">
            </a>
            ...
            <div class="nav-right-buttons d-flex align-items-center">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="user-profile-nav d-flex align-items-center">
                        <a href="<?php echo e(route('profile')); ?>" class="d-flex align-items-center text-decoration-none profile-link">
                            <span class="text-white me-3 fw-light">Hi, <?php echo e(Auth::user()->name); ?></span>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn text-white me-3 text-decoration-none">Login</a> 
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-gold">Register</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
                ...
                <div class="row g-0">
                    <div class="col-md-4 room-type-item">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('assets/img/icons/icon_superior.svg')); ?>" alt="Superior">
                        </div>
                    ...
                    <div class="col-md-4 room-type-item divider-left">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('assets/img/icons/icon_deluxe.svg')); ?>" alt="Deluxe">
                        </div>
                        <h6>Deluxe Suites</h6>
                        <p>Kamar yang memiliki harga terjangkau, cocok untuk tempat transit agar perjalananmu selanjutnya, badan kamu merasa lebih segar</p>
                    </div>
                    ...
                    <div class="col-md-4 room-type-item divider-left">
                        <div class="icon-container">
                            <img src="<?php echo e(asset('assets/img/icons/icon_executive.svg')); ?>" alt="Executive">
                        </div>
...
<section class="py-5 bg-white text-center">
    <div class="container py-4">
        ...
        <div class="row g-4">
            <div class="col-md-3 hotel-card"><img src="<?php echo e(asset('assets/img/fave_hotel 1.png')); ?>" alt="Hotel 1"></div>
            <div class="col-md-3 hotel-card"><img src="<?php echo e(asset('assets/img/hotel_aston 1.png')); ?>" alt="Hotel 2"></div>
            <div class="col-md-3 hotel-card"><img src="<?php echo e(asset('assets/img/novotel 1.png')); ?>" alt="Hotel 3"></div>
            <div class="col-md-3 hotel-card"><img src="<?php echo e(asset('assets/img/Rectangle 1.png')); ?>" alt="Hotel 4"></div>
        </div>
    </div>
</section>
        ...
        <div class="row g-5">
            ...
            <div class="col-md-4 service-item d-flex flex-column align-items-center">
                <div class="icon-container-dark mb-3">
                    <img src="<?php echo e(asset('assets/img/icons/'.$service['img'])); ?>" alt="<?php echo e($service['title']); ?>" width="40">
                </div>
                <h5 class="fw-bold mt-2 text-dark"><?php echo e($service['title']); ?></h5>
                <p class="text-muted small px-3"><?php echo e($service['desc']); ?></p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project laravel\laravel\resources\views/welcome.blade.php ENDPATH**/ ?>